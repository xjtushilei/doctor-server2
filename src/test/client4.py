...
def get_doctors():
    ...
    session = {
        ...
        "questions": [
            ...
            {'type': 'multiple',
             ...
             'seqno': 2}
            ,
            {'choices': ['肝区肿大', '咽部异物感', '呕血', '甲状腺机能亢进', '过敏'],
             'query': '您有哪些不舒服的症状？',
             'choice': '',
             'seqno': 3,
             'type': 'multiple'},

            {'choices': ['胸片示肺内孤立结节', '咽痛', '咳血痰', '胸痛', '寒战'],
             'query': '你有哪些不舒服的症状?',
             'seqno': 4,
             'type': 'multiple'
             }
    ...
    create_session = {
        "sessionId": "12345",
        "requestUrl": "/v1/doctors?clientId=mobimedical&orgId=abc&sessionId=12345&seqno=4&query=你有哪些不舒服的症状&choice=有点恶心",
